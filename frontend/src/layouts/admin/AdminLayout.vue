...
<template>
  <div class="layout">
    <header class="topbar">
      <div class="brand">Freshmart IRS 管理端</div>
      <nav class="nav">
        <RouterLink class="nav__link" to="/manager/me">/manager/me</RouterLink>
        <RouterLink v-if="hasToken && canSeeCatalog" class="nav__link" to="/manager/products">/manager/products</RouterLink>
        <RouterLink v-if="hasToken && canSeeCatalog" class="nav__link" to="/manager/inventory">/manager/inventory</RouterLink>
        <RouterLink v-if="hasToken && canSeeCatalog" class="nav__link" to="/manager/inventory/ledgers">/manager/inventory/ledgers</RouterLink>
        <RouterLink v-if="canSeeUsers" class="nav__link" to="/manager/users">/manager/users</RouterLink>
      </nav>
      <div class="session">
